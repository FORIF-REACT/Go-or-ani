...
const betting_card_lists: BettingInfoDto[] = [
  {
    ...
    title: "무야호",
    username: "김 아무개",
    time: new Date("1972-11-21 10:40").getTime(),
    participants: 523,
    img_src: "https://www.w3schools.com/html/pic_trulli.jpg",
    selections: ["무한", "무야호"],
  },
  {
    id: 2,
    title: "더 극혐인거 고르기 : 민트초코 vs 하와이안 피자",
    username: "에이다 러브레이스",
    time: new Date("2024-03-14 21:14").getTime(),
    participants: 1111,
    img_src: "https://www.w3schools.com/html/img_girl.jpg",
    selections: ["민트초코", "하와이안 피자", "민트초코 하와이안 피자"],
  },
  {
    id: 3,
    title: "사나이 눈물",
    ...
    time: new Date("1972-11-21 10:40").getTime(),
    participants: 523,
    img_src: "https://www.w3schools.com/html/img_chania.jpg",
    selections: ["약하다", "욕하지마"],
  },
  {
    id: 4,
    title: "최고의 휴양지 고르기 : 몰디브 vs 발리",
    username: "제임스 본드",
    time: new Date("2023-05-21 14:00").getTime(),
    participants: 789,
    img_src: "https://www.w3schools.com/html/pic_trulli.jpg",
    selections: ["몰디브", "발리"],
  },
  {
    id: 5,
    title: "라면에 계란 넣기 vs 안넣기",
    username: "나미",
    time: new Date("2024-01-12 08:45").getTime(),
    participants: 932,
    img_src: "https://www.w3schools.com/html/img_girl.jpg",
    selections: ["넣기", "안넣기"],
  },
...
function Home() {
  const [selectedBettingInfo, setSelectedBettingInfo] =
    useState<BettingInfoDto | null>(null);
  ...
  const goToNextCard = () => {
    setCurrentCardIndex(
      (prevIndex) => (prevIndex + 1) % betting_card_lists.length
    );
  };
  ...
  return (
    <div className="w-[1024px] mt-10 flex flex-col gap-4">
      ...
      {selectedBettingInfo && (
        <BettingModal
          selectedBettingInfo={selectedBettingInfo}
          setSelectedBettingInfo={setSelectedBettingInfo}
        />
      )}
      <div className="h-20"/>
