 ...
 * img_src : 이미지 경로
 */
export default function BettingCardinHome({bettingInfoDto, setSelectedBettingInfo} : {bettingInfoDto:BettingInfoDto, setSelectedBettingInfo:React.Dispatch<React.SetStateAction<BettingInfoDto|null>>}) {
